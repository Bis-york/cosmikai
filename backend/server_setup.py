"""Serve the CosmiKai backend API with a readiness check for MongoDB."""
...
# Since we're running from the backend directory, we need to ensure imports work
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the CosmiKai backend API and ensure MongoDB is reachable.")
